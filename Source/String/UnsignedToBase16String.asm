...
;*
;*  NAME
;*	UnsignedToBase16String.asm
;*
;*   DESCRIPTION
;*	Converts an unsigned integer to a string in base 16.
;*
;*  AUTHOR
...
;=
;=   NAME
;=	UnsignedToBase8String@ - Converts an unsigned integer to a base-16 string.
;=
;=   DESCRIPTION
...
;=
;===============================================================================================================*/
String$UnsignedToBase16String  PROC
	PUSHES		RDX
...
NotZero :
	...
	ADD		RDX, 17						; We will have at most 16 digits
...
ConversionLoop :
	...
	SHR		RCX, 4						; Get read from that nibble
	...
	POPS		RDX, RBX, RCX
	RET
String$UnsignedToBase16String  ENDP

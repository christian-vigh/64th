...
;*
;*  NAME
;*	UnsignedToBase2String.asm
;*
;*   DESCRIPTION
;*	Converts an unsigned integer to a string in base 2.
;*
;*  AUTHOR
...
;=
;=   NAME
;=	UnsignedToBase2String@ - Converts an unsigned integer to a base-2 string.
;=
;=   DESCRIPTION
...
;=
;===============================================================================================================*/
String$UnsignedToBase2String  PROC
	PUSHES		RDX
...
NotZero :
	...
	ADD		RDX, 64						; We will have at most 64 digits
...
ConversionLoop :
	...
	SHR		RCX, 1						; Get read from that nibble
	...
	POPS		RDX, RBX, RCX
	RET
String$UnsignedToBase2String  ENDP
